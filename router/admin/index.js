...
indexApp.get('/',[user.lastLoginTime, pv.getTotal, article.getCount, category.getCount], (req, res)=>{
	let { lastLoginTime,pvTotal, articleCount, categoryCount } =req
	res.render('admin/index',{user:req.user, lastLoginTime: lastLoginTime, pvTotal: pvTotal, articleCount: articleCount, categoryCount: categoryCount })
})
